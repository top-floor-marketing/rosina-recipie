const template = ({
  ...
  return /* html */`
  <div class="card" style="width: 22rem; box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
    ...
    <div class="card-body px-2 py-3">
      <div class="row">
        ...
        <div class="col-4 p-0">
          <div class="row d-flex justify-content-center align-items-center">
            <i class="fas fa-star mr-2" style="color: #FCD127; font-size: 24px"></i>
      ...
      <div class="row mt-4">
        ...
        <div class="col-9 pl-0 d-flex-row m-auto">
          <p class="card-title font-weight-light mb-0" style="font-size: 15px; color: #F42434">Submited by:</p>
          <p class="card-title font-weight-bold mb-0" style="font-size: 15px; color: #F42434">${userName}</p>
        </div>
      </div>
    </div>
  </div>
